...
class target(opt.OptimizationTarget):
    ...
    def runnerFunction(self):
        value = operation(self.chromosomes['value'])
...
t = target()
t.chromosomes['value'] = states
t.chromosomes_lower_bounds['value'] = [0] * 100
t.chromosomes_upper_bounds['value'] = [9] * 100
...
optimizer = opt.OptimizerGA(t, 100, 100)
...
print(optimizer.bestOrganism.chromosomes['value'])
